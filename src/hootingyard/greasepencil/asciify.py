# -*- coding: utf-8 -*-
# use a dynamically populated translation dictionary to remove accents from a string

# This is third-party code:
# See http://chmullig.com/2009/12/python-unicode-ascii-ifier/
...
def asciify(text):  # type: (unicode) -> str
    try:
        return text.encode('ascii')
    except AttributeError:
        return str(text).encode('ascii')
    except UnicodeEncodeError:
        return unicodedata.normalize('NFKD', text.translate(Map)).encode('ascii', 'replace')
