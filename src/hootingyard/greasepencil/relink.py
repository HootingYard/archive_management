...
for toca in toc.xpath("//a"):
    ...
    if filename == 'preface.xhtml': continue
    ...
    for a in html.xpath("//a"):
        ...
        if link:
            ...
            if href == 'http://hootingyard.org/archives/8352#comments':
                ...
                a.set('class', 'hootingyard')
                print '*', href
                extpage = etree.parse(urllib.urlopen(href), etree.HTMLParser())
                exta = extpage.xpath("//h1[@class='entry-title'][1]/a")[0]
                a.set('title', grease.text_only(exta))
